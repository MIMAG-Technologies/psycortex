...
function About() {
  return (
    <div id="About">
      ...
      <div>
        <h1>Legal Venture Name: Psycortex Brain Take Mental Health Pvt. Ltd</h1>
        <p>
          Welcome to Psycortex Brain Take Mental Health Pvt. Ltd, where we
        ...
        <p>
          At Psycortex, we recognize the intricate interplay between mind, body,
          and spirit, and our team of experienced psychologists, therapists, and
          counselors are committed to offering personalized and effective
          treatment plans tailored to your unique needs. Whether you're
          grappling with the weight of anxiety, depression, trauma, or facing
          challenges in relationships and personal growth, we are here to guide
          you towards profound healing and self-discovery.
        </p>
        <p>
        ...
        <p>
          ...
          Brain Take Mental Health Pvt. Ltd today, and embark on a
